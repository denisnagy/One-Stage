...
class ProfileGenerator {
    ...
    public function createCoverPhotoSection() {
        ...
        return "<div class='coverPhotoContainer'>
                    ...
                    <span class='userCoverFullName'>$name</span>
                </div>";
    }
    ...
    public function createHeaderSection() {
        ...
        $name = $this->profileData->getProfileUserFullName();
        $followersCount = $this->profileData->getFollowersCount();
        ...
        return "<div class='profileHeader'>
                    ...
                    <div class='userInfoContainer'>
                        <div class='userInfo'>
                            ...
                            <span class='followersCount'>$followersCount followers</span>
                        </div>
    ...
    public function createContentSection() {
        ...
        // Creating the about content for user
    ...
    private function createHeaderButton() {
        if($this->userLoggedInObj->getUsername() == $this->profileData->getProfileUsername()) {
            ...
            return ButtonProvider::createFollowerButton($this->con, $this->profileData->getProfileUserObj(), $this->userLoggedInObj);
        }
    }
